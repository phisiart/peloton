...
class DeleteTranslatorTest : public PelotonCodeGenTest {
 public:
  ...
  void TestPredicate(expression::AbstractExpression *predicate) {
    ...
    timer.Stop();
    LOG_INFO("Interpreted Exec: %.2f ms\n", timer.GetDuration());
...
//TEST_F(DeleteTranslatorTest, DeleteAll) {
//  this->TestPredicate(nullptr);
//}

TEST_F(DeleteTranslatorTest, DeleteAllExecutor) {
  this->TestDeleteExecutor(nullptr);
}

TEST_F(DeleteTranslatorTest, DeleteAllTranslator) {
  this->TestDeleteTranslator(nullptr);
}

TEST_F(DeleteTranslatorTest, DeleteOneTranslator) {
  auto* a_col_exp =
...
TEST_F(DeleteTranslatorTest, DeleteOneExecutor) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_40_exp = CodegenTestUtils::ConstIntExpression(40);
  auto* a_equal_40 = new expression::ComparisonExpression(
...
TEST_F(DeleteTranslatorTest, DeleteMinorityExecutor) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_40_exp = CodegenTestUtils::ConstIntExpression(40);
...
TEST_F(DeleteTranslatorTest, DeleteMinorityTranslator) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_40_exp = CodegenTestUtils::ConstIntExpression(40);
  auto* const_0_exp = CodegenTestUtils::ConstIntExpression(0);
...
TEST_F(DeleteTranslatorTest, DeleteHalfExecutor) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
...
TEST_F(DeleteTranslatorTest, DeleteHalfTranslator) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_20_exp = CodegenTestUtils::ConstIntExpression(20);
  auto* const_0_exp = CodegenTestUtils::ConstIntExpression(0);
...
TEST_F(DeleteTranslatorTest, DeleteMajorityExecutor) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_40_exp = CodegenTestUtils::ConstIntExpression(40);
  auto* const_0_exp = CodegenTestUtils::ConstIntExpression(0);
...
TEST_F(DeleteTranslatorTest, DeleteMajorityTranslator) {
  auto* a_col_exp =
      new expression::TupleValueExpression(type::Type::TypeId::INTEGER, 0, 0);
  auto* const_40_exp = CodegenTestUtils::ConstIntExpression(40);
  auto* const_0_exp = CodegenTestUtils::ConstIntExpression(0);
