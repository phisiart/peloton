...
DEFINE_METHOD(peloton::codegen, RuntimeFunctions, ParallelHashJoinInit);
DEFINE_METHOD(peloton::codegen, RuntimeFunctions, ParallelHashJoinMerge);
DEFINE_METHOD(peloton::codegen, RuntimeFunctions, ParallelHashJoinDestroy);
